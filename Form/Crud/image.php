...
$navbar = new Navbar();
    ...
    $navbar->AddItem('', 'Fomr/Crud/image.php', 'center', true, 'bi bi-image" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-custom-class="super-tooltip" title="Ajouter une image');
